class Bss {
	#classWrapper = 'bss-wrapper'
	#classItem = 'dropdown-item'
	#classItems = 'bss-items'
	#classClear = 'bss-clear'
	#classHeader = 'dropdown-header'
	#classHidden = 'd-none'
	#classNoResults = 'bss-no-results'
	#classTagRemove = 'bss-tag-remove'
	...
	#setSelectedOption(value: string, selected: boolean) {
